...
conf_b_lm10uu = [5, 9.7, 29, 0, "lm10uu bearing (10mm shaft)"];
conf_b_lme8uu =[4, 8.2, 25, 0, "lme8uu bearing"];
conf_b_lm12uu = [6, 10.6, 30, 0, "lm12uu bearing (12mm shaft)"];

//longer bearings
conf_b_lm8luu = [4, 7.7, 45, 0, "lm8luu bearing (double length)"];
conf_b_lm10luu = [5, 9.7, 55, 0, "lm10luu bearing (10mm shaft, long)"];
